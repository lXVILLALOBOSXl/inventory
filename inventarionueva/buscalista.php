...
$consultaLista = "select producto.imagenProducto, tipoproducto.nombreProducto, marcaproducto.nombreMarca, cantidadproducto.cantidad, unidadproducto.unidad, producto.codigoInterno from producto inner join tipoproducto on tipoproducto.idTipoProducto = producto.idTipoProducto inner join marcaproducto on marcaproducto.idMarcaProducto = producto.idMarcaProducto inner join cantidadproducto on cantidadproducto.idCantidadProducto = producto.idCantidadProducto inner join unidadproducto on unidadproducto.idUnidadProducto = producto.idUnidadProducto where codigoProducto = '$codigoProducto'";
